...
const UpdateNsxtSecurityPolicyRuleForm = ({loading, updateFormState, values, groupOptions, serviceOptions}) => {
  if(loading){
    return (
...
UpdateNsxtSecurityPolicyRuleForm.defaultProps = {
  loading: false,
  groupOptions: [],
  serviceOptions: []
};

export default UpdateNsxtSecurityPolicyRuleForm;